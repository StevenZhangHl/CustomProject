...
public class CortpFooter extends RelativeLayout implements RefreshFooter {
    ...
    public CortpFooter(Context context) {
        super(context);
        this.initView(context, null, 0);
    }

    public CortpFooter(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.initView(context, attrs, 0);
    }

    public CortpFooter(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        this.initView(context, attrs, defStyleAttr);
    }

    private void initView(Context context, AttributeSet attrs, int defStyleAttr) {
        REFRESH_FOOTER_PULLUP = context.getString(R.string.load_more);
        REFRESH_FOOTER_RELEASE = context.getString(R.string.load_now);
        ...
        REFRESH_FOOTER_FINISH = context.getString(R.string.load_complete);
...
//                    replaceRefreshLayoutBackground(refreshLayout);
    ...
    public CortpFooter setPrimaryColor(@ColorInt int primaryColor) {
    ...
    public CortpFooter setAccentColor(@ColorInt int accentColor) {
